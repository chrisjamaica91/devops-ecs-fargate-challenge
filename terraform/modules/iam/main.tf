...
# This role is used by ECS to pull images and manage logs
...
# ECS Task Role
# This role is used by the running containers themselves
...
# Jenkins IAM Role
# This role allows Jenkins EC2 instance to interact with ECR and ECS
...
# Jenkins Policy - ECR permissions
...
# Jenkins Policy - ECS permissions
